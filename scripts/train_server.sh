...
#python -m src.clf.trainer --num_labels 2 --model_name_or_path bert-base-uncased --output_dir results_history \
#--train_batch_size 1 \
#--eval_batch_size 1 \
#--learning_rate 2e-5 \
#--num_labels 2 \
...
#--val_path "data/val.tsv"
#
#python -m src.clf.trainer --num_labels 2 --model_name_or_path bert-base-uncased --output_dir 0/results_history_style \
#--train_batch_size 1 \
#--eval_batch_size 1 \
#--learning_rate 2e-5 \
#--num_labels 2 \
